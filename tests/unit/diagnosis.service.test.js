...
describe('getDiagnoses', () => {
  ...
  it('should throw if patient not found', async () => {
    ...
    await expect(
      diagnosisService.getDiagnoses({ patientUuid: 'patientUuid' })
    ).rejects.toThrow();
  });
});
...
describe('updateDiagnosisClinicalStatus', () => {
  it('should update successfully', async () => {
    ...
    const result = await diagnosisService.updateDiagnosisClinicalStatus(
      'diagnosisUuid',
      'RESOLVED',
      345
    );
  ...
  it('should throw if not found', async () => {
    ...
    await expect(
      diagnosisService.updateDiagnosisClinicalStatus('diagnosisUuid', 'RESOLVED', 543)
...
describe('updateDiagnosisRecordStatus', () => {
  it('should update successfully', async () => {
    ...
    const result = await diagnosisService.updateDiagnosisRecordStatus(
      'diagnosisUuid',
      'INACTIVE',
      43
    );
